        ...
        myhtml += '<div class="gallery_label">'+label+'</div>';
            ...
            myhtml += '<ul class="gallery" id="gallery'+id+'">';
                for(i = 0; i < gallery_num_array[id]; i++){
                    myhtml += '<li data-original="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][i]+'/001.jpg" class="lazy g'+id+'s'+i+'">'+
    ...
    if (ua.indexOf('iPhone') > -1 || (ua.indexOf('Android') > -1 && ua.indexOf('Mobile') > -1)) {
        // スマートフォン
            ...
            for(i = 1; i <= sub_num_array[id][sid]; i++){
                ...
                myhtml += 
                    '<li style="display: list-item; background-image: url(&quot;photo/'+gallery_id_array[id]+'/'+sub_id_array[id][sid]+'/'+k+'.jpg&quot;);"><a href="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][sid]+'/'+k+'.jpg"></a>'+
                    '</li>' 
            }
            myhtml += '</ul></div>';
            $("#gallery").append(myhtml);
        ...
        $(".modal-window").empty();
            ...
            for(i = 1; i <= sub_num_array[id][sid]; i++){
                if(i < 10) {k = "00"+i;} else {k = "0"+i;}
                myhtml += 
                    '<li ><a href="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][sid]+'/'+k+'.jpg"  data-lightbox="lgbpc">'+
                    '<img src="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][sid]+'/'+k+'.jpg" class="lazy"></a></li>'
            }
