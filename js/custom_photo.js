...
$(document).ready(function(){
    ...
    function gallery_load(id){
        ...
        myhtml += '<div class="gallery_label"></div>';
            ...
            myhtml += '<ul class="gallery" id="gallery'+id+'">';
                for(i = 1; i < sub_num_array[id][num]; i++){
                    if(i<10){i = '0' + i}
		    myhtml += '<a href="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][num]+'/0'+[i]+'.webp"  data-lightbox="lgbpc">'
                    myhtml += '<li data-original="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][num]+'/0'+[i]+'.webp" class="lazy g'+id+'s'+num+'"></li></a>'
                }
            myhtml += '</ul></div>';
        ...
        // PC
            ...
            id = 0
                for(i = 0; i < gallery_num_array[id]; i++){
                	for(j = 0; j < 9; j++){
                    		myhtml += '<li data-original="photo/'+gallery_id_array[id]+'/'+sub_id_array[id][i]+'/00'+[j]+'.webp" class="lazy g'+id+'s'+i+'">'
                	}
                }
    ...
    $('#gallery_nav .gallery_title').mouseenter(function() {
        var myID = $(this).attr("id");
        //ナビアイテムのアクティブ化
        var $navItem = $("#gallery_nav").find('.gallery_title');
        $navItem.css('color','#969696');
